...
class clienteController extends Controller
{
    ...
    {
        $response = Http::get('https://apijyt.herokuapp.com/cliente');
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::post('https://apijyt.herokuapp.com/cliente/insertar', [
    ...
    {
        $response=Http::get('https://apijyt.herokuapp.com/cliente/'.$cod_cliente);
    ...
    public function update(Request $request, $cod_cliente)
    {
        ...
        $response = Http::put('https://apijyt.herokuapp.com/cliente/actualizar/' . $cod_cliente, [
            'cliente_nombre' => $request->Nombre,
            'cliente_apellido' => $request->Apellido,
            'clinte_correo' => $request->Correo,
            'cliente_dni' => $request->DNI,
    ...
    {
        $eliminar = Http::delete('https://apijyt.herokuapp.com/cliente/eliminar/'.$cod_cliente);
        return redirect()->route('cliente.index');
    }
}
