...
@section('title', '| Crear Rol usuario')
...
@section('content')
    <form action="{{route('rolusuarios.store')}}" method='POST'>
        @csrf
        <div class="card  mb-2">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Tipo Rol</label>
                 <div class="col-sm-7">
                    <input type="text" id="Rol" name="Rol" class="form-control" placeholder="Ingrese el tipo de rol">
                </div>
                @if ($errors->has('Rol'))
                    <div               
                        id="Rol-error"                               
