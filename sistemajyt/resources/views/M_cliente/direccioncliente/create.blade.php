...
@section('title', '| Crear Direccion cliente')
...
@section('content')
    <form action="{{route('direccioncliente.store')}}" method='POST'>
        @csrf
        <div class="card  mb-2">
            <div  class="row mb-3">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Ciudad</label>
                 <div class="col-sm-7">
                    <input type="text" id="Ciudad" name="Ciudad" class="form-control" placeholder="Ingrese la direccion de la ciudad">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Direccion Telefono</label>
                 <div class="col-sm-7">
                    <input type="text"  maxlength="30" id="Telefono" name="Telefono" class="form-control" placeholder="Ingrese el Telefono">
                </div>
